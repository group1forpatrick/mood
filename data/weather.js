...
const owm_api = "https://api.openweathermap.org/data/2.5/weather?zip={zip code}&units=imperial&APPID=49925dfe45be1e525f0ed1e2e01bc41f";
...
async function getWeather(zip) {
    ...
    const {data} = await axios.get(addy).catch(function (e) {
            console.log(`Weather: Error ${e.response.status}, ${e.response.data.message}`);
    });
